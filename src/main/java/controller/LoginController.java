...
public class LoginController extends AbstractController {
	...
	private static final String msgErreur = "<div class=\"alert alert-danger\">" + "<b>Erreur d'authentification</b>"
			+ "<ul>" + "%s" + "</ul>" + "</div>";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (authentificatedUser != null) {
			...
			this.buildAndAttachErrorMessage(request, "Authentification impossible",
					"L'adresse email ou le mot de passe sont incorrects");
