...
<div id="wrapper">
    ...
    <div id="page-content-wrapper">
        <div>
            ...
            <form class="col-lg-6 formulaire" method="post">
                <legend>Connexion</legend>
                ${msgErreur}
                <label for="mail">Adresse mail : </label>
                <input id="mail" required type="email" class="form-control" name="email"><br/>
                <label for="mdp">Mot de passe : </label>
                <input id="mdp" type="password" class="form-control" name="password">
