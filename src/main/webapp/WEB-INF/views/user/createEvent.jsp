        ...
        <div>
            <form class="col-lg-10 formulaire"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-4">
                        <input required type='text' class="form-control"
                               id='datetimepickerfirst' name="datetimepickerfirst" value="${dateBegin}"/>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-4">
                        <input required type='text' class="form-control"
                               id='datetimepickerend' name="datetimepickerend" value="${dateEnd}"/>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <c:if test="${isUpdate}">
                    <div class="col-xs-9 col-xs-offset-3">
                        <button type="submit" class="btn btn-primary btn-lg">Modifier l'evenement</button>
                    </div>
                </c:if>
                <c:if test="${!isUpdate}">
                    <div class="col-xs-9 col-xs-offset-3">
